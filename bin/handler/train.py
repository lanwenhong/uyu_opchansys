...
class TrainBuyInfoHandler(core.Handler):
    ...
    def _get_handler(self, *args):
        ...
        try:
            ...
            info_data, total = self._query_handler(offset, limit, channel_name, store_name, consumer_id, start_time, end_time, status)
...
class TrainUseInfoHandler(core.Handler):
    ...
    def _get_handler(self, *args):
        ...
        try:
            ...
            offset, limit = tools.gen_offset(curr_page, max_page_num)
            info_data, total = self._query_handler(offset, limit, channel_name, store_name, consumer_id, eyesight, create_time)
